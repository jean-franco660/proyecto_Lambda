...
def generar_reporte_json(nombre_archivo, columnas, total_filas):
    return {
...
def lambda_handler(event, context):
    ...
    reporte = generar_reporte_json(file_key, columnas, total_rows)
    ...
    # Generar y subir gráfico si hay datos numéricos
